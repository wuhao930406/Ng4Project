...
<div class="showTop">
  <div class="mainBox">
    <a *ngIf ="ifs==true" routerLink="/public" ><img [src]="picurl+'logo3.jpg'"></a>
    <a *ngIf ="ifs==false" routerLink="/public" ><img [src]="picurl+'logo9.jpg'"></a>
    <a *ngIf ="ifs2==true" routerLink="/public" ><img [src]="picurl+'logo3.jpg'"></a>
    <div class="topBtn">
